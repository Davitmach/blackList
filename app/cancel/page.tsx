...
export default function Page() {
    ...
    return(
        ...
        <div className="max-w-[500px] pb-[120px] mx-auto w-full px-[20px] flex flex-col items-center gap-[15px] mt-[30px]">
            ...
            <div><p className="text-[#926C88] text-[14px] font-[400]">1. Отменить подписку через приложение банка, в котором находится Ваша карта для платы подписки.<br/>
2. Отменить подписку по кнопке ниже.  Важно! После отмены подписки Ваши данные об оплате полностью удалятся и для оформления новой подписки необходимо будет вводить их заново. <br/><br/>
В соответствии с Правилами Пользования, клиент имеет право самостоятельно отменить подписку. При возникновении сложностей с отменой подписки просим вас обратиться в Службу Поддержки и описать пробему. Мы оперативно поможем с решением в рабочее время.</p></div>
